						...
						<Container>
							<Row md={4} className='mt-5 mb-5'>
								<Col>
									...
									accusamus est eveniet rem quis illum accusantium incidunt assumenda fugit nesciunt
									quos error at, alias esse eaque? Eos, iure maxime?
								</Col>

								<Col xs={3}>
									<Image
										className='challenges ml-3 mb-5'
										src='/images/imagesSVG/undraw_To_do_list_re_9nt7.svg'
									/>
								</Col>
							</Row>
							<Row md={4}>
								...
								<Col xs={3}>
									<Image
										className='remote ml-3 mb-5'
										src='/images/imagesSVG/undraw_Freelancer_re_irh4.svg'
									/>
								</Col>
							</Row>
							<Row md={4}>
								...
								<Col xs={3}>
									<Image
										className='interviews ml-5 mb-5'
										src='/images/imagesSVG/undraw_group_video_el8e.svg'
									/>
								</Col>
							</Row>
							<Row md={4}>
								...
								<Col xs={3}>
									<Image
										className='remote ml-3 mb-5'
										src='/images/imagesSVG/undraw_Done_checking_re_6vyx.svg'
									/>
								</Col>
							</Row>
						</Container>
